...
!
implicit none
character(len=80)::file1,line
real*8::coord(3,3,24)=0,rc1(3)=0,rn1(3)=0,rn2(3)=0,rc2(3)=0
real*8::getbond,getbang,getbtor,bond,ang1,ang2,tor
integer::n=0,l=0,m=0,j=0,k=0,hit(24,24)=0,io,io1
...
read(11,100,iostat=io)file1 !read in the name of the simulation output file
 ...
 open(unit=22, file='working') 
  ...
  ! write(*,*)line
   ...
   write(22,*) adjustl(adjustl(line(31:54))) !write the CNC coordinate of each residue into the working file
   !write(*,*)line(31:54)
   endif
   endif
   endif
