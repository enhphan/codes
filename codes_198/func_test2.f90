...
real*8::coord(3,3,32)=0,rc1(3)=0,rn1(3)=0,rn2(3)=0,rc2(3)=0
real*8::getbond,getbang,getbtor,bond,ang1,ang2,tor,x,y,z
integer::n=0,l=0,m=0,j=0,k=0,hit(32,32)=0,io,io1
...
!write(13,101) coord(1,1,2),coord(2,1,2),coord(3,1,2)
    do m=1,31 !loop over the coordinates of the 24 residue in the polyuracil pairwise
     j=m+1 
     do l=j,32 !
      rn1(1)=coord(1,2,m)
      rn1(2)=coord(2,2,m)
